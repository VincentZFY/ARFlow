...
from transforms.co_transforms import get_co_transforms,get_co_transforms_SSL
from transforms.ar_transforms.ap_transforms import get_ap_transforms
from transforms import sep_transforms
from datasets.flow_datasets import SintelRaw, Sintel, SintelSSL
...
def get_datasetSSL(all_cfg):
    ...
    if cfg.type == 'Sintel_Flow':
        ...
        supervised_set_1 = SintelSSL(cfg.root_sintel, n_frames=cfg.train_n_frames, type='clean',
                             split='training', subsplit=cfg.train_subsplit,
                             with_flow=True,
                             ap_transform=ap_transform,
                             transform=input_transform,
                             ...
                             supervised_target_transform={'flow': sep_transforms.ArrayToTensor()}
                             )
        supervised_set_2 = SintelSSL(cfg.root_sintel, n_frames=cfg.train_n_frames, type='final',
                             split='training', subsplit=cfg.train_subsplit,
                             with_flow=True,
                             ap_transform=ap_transform,
                             transform=input_transform,
        ...
        supervised_set = ConcatDataset([supervised_set_1, supervised_set_2])

        unsupervised_set_1 = SintelSSL(cfg.root_sintel, n_frames=cfg.train_n_frames, type='clean',
                             split='training', subsplit=cfg.train_subsplit,
                             with_flow=False,
                             ap_transform=ap_transform,
                             transform=input_transform,
                             ...
                             supervised_target_transform=None
                             )
        unsupervised_set_2 = SintelSSL(cfg.root_sintel, n_frames=cfg.train_n_frames, type='final',
                             split='training', subsplit=cfg.train_subsplit,
                             with_flow=False,
                             ap_transform=ap_transform,
                             transform=input_transform,
        ...
        unsupervised_set = ConcatDataset([unsupervised_set_1, unsupervised_set_2])
        ...
        raise NotImplementedError(cfg.type)
    return supervised_set, unsupervised_set, valid_set